  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user && data.session) {
        // Auto-confirm enabled — seed categories then go to dashboard
        await fetch('/api/categories/seed', { method: 'POST' });
        toast.success('Account created! Welcome to TODEI-LIST 🌿');
    ...
    return (
      <div className="animate-bounce-in text-center">
        <div className="card p-8">
          ...
          <h2
            className="text-2xl font-extrabold text-bark-600 mb-3"
  ...
  return (
    <div className="animate-slide-up">
      <div className="text-center mb-8">
        ...
        <p className="text-bark-400 font-medium">Join the cozy productivity club! 🌿</p>
      </div>
      ...
      <div className="card">
        <form onSubmit={handleSignup} className="flex flex-col gap-5">
          ...
          <div>
            ...
            <p className="text-xs text-bark-400 mt-1 font-medium">
